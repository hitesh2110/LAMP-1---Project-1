...
namespace Demo\Views\Pages
{
     ...
     * GettingStarted
     */
    class GettingStarted extends \McGowan\View
    {
        /**
         * __construct
         *
         ...
         *
         * @access public
         * @param \McGowan\View Contains the child view to render as the main content page.
         * @return mixed
         */
        public function content(\McGowan\View $view = null)
        {
            if( null === $view ) {
